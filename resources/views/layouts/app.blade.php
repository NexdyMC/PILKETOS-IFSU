...
<body class="text-gray-800 bg-gray-100">
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-56 p-4 space-y-2 text-white bg-gray-900">
            ...
            <a href="/dashboard?tab=home" class="block px-3 py-2 rounded tab-link hover:bg-gray-700" data-tab="home">
                Home
            </a>
            <a href="/dashboard?tab=projects" class="block px-3 py-2 rounded tab-link hover:bg-gray-700" data-tab="projects">
                Projects
            </a>
